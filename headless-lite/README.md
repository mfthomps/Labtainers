...
7. Copy the motd, docker-entrypoint, and wait-for-it.sh files to $LABTAINERDIR/scripts/designer/workspace_master folder 
`cd headless-lite && cp motd docker-entrypoint wait-for-it.sh ../scripts/designer/workspace_master/` 
8. Copy the Dockerfile.labtainer.master to $LABTAINERDIR/scripts/designer/workspace_master. 
...
11. Cd to headless-lite directory. `cd $LABTAINERDIR/headless-lite/`
