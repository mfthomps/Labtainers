...
mechanisms for automating the collection of student lab reports into the zip files
...
timestamped snapshots of transitory data such as stdout of a program.  Lab designers can generate
