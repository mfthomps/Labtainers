...
Programs that are monitored, e.g., via treataslocal, are killed if the student presses ctl-c,
regardless of the program's trap handling.  Thus programs whose interface definition includes
such interrupts cannot be monitored without altering the programs behavior.
