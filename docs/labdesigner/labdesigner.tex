...
\item MACVLAN [IP prefix] -- Causes the Docker network driver to create and use a macvlan tied to the ethernet
...
\item IP\_RANGE [range] -- Allocates an ip range to the network, e.g., 192.168.1.4/30
\end{itemize}
