...
To perform a specific Labtainer exercise, the student runs a \textit{start.sh} command from
...
\url{https://tor.ern.nps.edu/svn/proj/labtainer}.
...
\item CONTAINER [container name] -- One of these sections is reqired for each container in the lab.
...
\item whether the artifict is in stdin or stdout
