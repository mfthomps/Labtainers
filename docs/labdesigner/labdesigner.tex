...
e.g., via email or a learning management system.  The instructor collects student zip files into a common
...
and the Docker package.  Our website also distributes pre-packaged VM appliances that already have
