      ...
      where:
            ...
            field_type - Optional, defaults to "TOKEN", possible values include:
                ...
                PARAM      -- The value of the nametag will be set to nth parameter
                              (starting at 1, named by the field_id), provided in the 
                              program invocation.  
  ...
  Where: 
    ...
    <type> - must be one of the following:
         ...
         'execute'     - The <operator> is treated as a file name of a script to 
                         ...
                         results.config 
         'count'       - The goal value is assigned the quanity of occurances of 
                         the given resulttag.  These types have no other fields.
