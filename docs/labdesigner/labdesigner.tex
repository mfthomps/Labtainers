...
\subsubsection{Converting artifact file format}
...
\end{verbatim}
\noindent An example of this conversion can be seen in the webtrack lab.
...
as well as files from other labs.  Designers should avoid addding duplicate tar files to the SVN repositotry.
