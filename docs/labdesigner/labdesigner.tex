      ...
      where:
            ...
            file_id -- Identifies a single file, or the set of files to be parsed.  The 
                ...
                [container_name:]<prog>.[stdin | stdout] | file_path
                   ...
                   home directory. 
                   A special character '*' in place of <prog> can be used as a 'wildcard',
                   i.e., *.stdin is for stdin artifacts and *.stdout is for stdout artifacts.
  ...
  <goal_id> = <type> : [<operator> : <resulttag> : <answertag> | <boolean_expression> 
    ...
    Where: 
      ...
      <type> - must be one of the following:
           ...
           'execute'     - For this special type, the <operator> will be an executable file
                           with the resulttag and answertag passed to the executable as arguments.
                           ...
                           Note: the answertag is not allowed to be symbolic name from 
                           results.config 
