...
\item Refresh branch registry from the premaster (unless building premaster) using {\tt refresh\_branch.py -r}
...
\item Update the premaster registry to match the development branch registry: {\tt ./refresh\_branch.py}
...
Revert to premaster in case of merge issues or other failures.
\begin{itemize}
