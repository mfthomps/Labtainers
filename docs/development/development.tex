...
In a Linux terminal, change working directory into the directory you want to store Labtainers.
...
The distributions are created from a local git repo, i.e., it does not pull from a remote repo.  The scripts first highlight
