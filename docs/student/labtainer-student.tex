...
Labtainers remotvely via a browser.
...
and its security considerations.  Download the script from \url{https://raw.githubusercontent.com/mfthomps/Labtainers/master/headless-lite/headless-labtainers.sh},
...
In addition to starting the Headless Labtainers, the script will create a ~/headless-labtainers directory.  You should then run
headless-labtainers.sh from that directory in the future.  That directory will also contain persistent data, including
...
A list of labtainer commands can be found in \ref{sec:appendixA} of this document. 
