...
are on the firewall component in the home directory.  
...
Then use the applications on the client to
...
Use nmap to confirm the proper configuration (this is required):
\begin{verbatim}
   nmap server
\end{verbatim}
