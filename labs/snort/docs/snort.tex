...
the externalally visible destination address to the internal web server address.
...
address on any  port is sent to any address on any port, and include this message and give
the rule an identifier of 00002.''
...
whenever the text "CONFIDENTIAL" is sent out to the internet.  Reference existing
rules to understand how to qualify alerts based on \textit{content}.  Be sure to include the
...
\end {verbatim}
This will not do!  The keen minds at the startup need to view their confidential
