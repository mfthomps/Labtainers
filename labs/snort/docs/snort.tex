...
The address fields may also identify excluded addresses.  For example, an address field of
{\tt ![192.168.2.0/24]} would apply to any and all IP addresses except those in the 192.168.2.0/24
subnetwork.

Armed with the above, alter your CONFIDENTIAL rule to exclude internal traffic.
