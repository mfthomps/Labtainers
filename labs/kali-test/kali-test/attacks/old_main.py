...
#End Scenario -- Changes IP to .100 
def end():
	printtime("Changing IP to 192.168.1.100 -- End of Scenario") 
	system('sudo ipconfig eth0 192.168.1.100')
...
def main():
	...
	# Start traffic generation
        subprocess.Popen(["python", "/root/Desktop/attacks/traffic.py"]) #Subprocess, In order for the program to simultaneously run traffic and continue forward with the scenario.
	...
	system('echo "" >> timer.txt') # new line 
	printtime("Expecting 3 minute TLX1() after buffer on security onion")
	...
	system('echo "" >> timer.txt') # new line 
	printtime("Expecting 3 minutes TLX2() after easy attack")
	time.sleep(s.counter*1)	
	...
	system('echo "" >> timer.txt') # new line 
	printtime("Expecting 3 minutes TLX3() after hard attack")
	time.sleep(s.counter*1)	
