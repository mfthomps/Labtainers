...
RUN echo -e 'slapd slapd/internal/adminpw password password' | debconf-set-selections
RUN echo -e 'slapd slapd/internal/generated_adminpw password password'| debconf-set-selections
RUN echo -e 'slapd slapd/password2 password password' | debconf-set-selections
RUN echo -e 'slapd slapd/password1 password password' | debconf-set-selections
RUN echo -e "slapd slapd/domain string example.com" |debconf-set-selections
RUN echo -e "slapd shared/organization string example" |debconf-set-selections
RUN echo -e "slapd slapd/backend string HDB" |debconf-set-selections
RUN echo -e "slapd slapd/purge_database boolean false" |debconf-set-selections
