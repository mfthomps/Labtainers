...
\begin{figure}[!htb]
\centering
\includegraphics*[viewport=50 120 750 520, width=0.9\textwidth]{Figs/topology.pdf}
...
\begin{figure}[!htb]
\centering
\includegraphics*[ width=0.9\textwidth]{Figs/DNS_Local_flow1.pdf}
...
\begin{figure}[!htb]
\centering
\includegraphics*[ width=0.9\textwidth]{Figs/DNS_Local_flow2.pdf}
