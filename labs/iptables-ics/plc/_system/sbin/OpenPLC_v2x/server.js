...
app.get('/run',function(req,res)
{
	if (plcRunning == false)
	{
		console.log('Starting OpenPLC Software... UniqueID');
...
app.get('/stop',function(req,res)
{
	if (plcRunning == true)
	{
		console.log('Stopping OpenPLC Software... UniqueID');
...
{
    console.log("Working on port 8080 UniqueID");
});
...
function showMainPage(req,res)
{
	...
	<html>\
		...
		<body>\
			<p align="center" style="font-family:verdana; font-size:60px; margin-top: 0px; margin-bottom: 10px">OpenPLC Server</p>\
			<p align="center" style="font-family:verdana; font-size:30px; margin-top: 0px; margin-bottom: 10px">Labtainerized UniqueID</p>';
			if (plcRunning == true)
			{
